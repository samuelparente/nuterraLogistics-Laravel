                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('users.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary mt-3"><i class="bi bi-pencil-square"></i> Atualizar Registo</button>
                            
                            <a href="{{ route('users.index') }}" class="btn btn-outline-secondary mt-3"><i class="bi bi-x-circle"></i> Cancelar</a>
