...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 mb-3"><strong>FUNCIONÁRIOS</strong> | Editar</h1>
        </div>

        <div class="row">
            <!-- Formulário para editar o funcionario -->
            <div class="col-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('staff.employee.update', $employee->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="address_1" id="address_1" class="form-control" value="{{ old('name', $employee->address_1) }}">
                            </div>
                
                            <div class="mb-3">
                                <label for="address_2" class="form-label">Morada 2</label>
                                <input type="text" name="address_2" id="address_2" class="form-control" value="{{ old('name', $employee->address_2) }}">
                            </div>
                
                            <div class="mb-3">
                                <label for="city" class="form-label">Cidade</label>
                                <input type="text" name="city" id="city" class="form-control" value="{{ old('name', $employee->city) }}">
                            </div>
                
                            <div class="mb-3">
                                <label for="district" class="form-label">Distrito</label>
                                <input type="text" name="district" id="district" class="form-control" value="{{ old('name', $employee->district) }}">
                            </div>
                
                            <div class="mb-3">
                                <label for="postal_code" class="form-label">Código Postal</label>
                                <input type="text" name="postal_code" id="postal_code" class="form-control" value="{{ old('name', $employee->postal_code) }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="mobile_phone" id="mobile_phone" class="form-control" value="{{ old('mobile_phone', $employee->mobile_phone) }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="observations" id="observations" class="form-control">{{ $employee->observations }}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                @foreach($classGroups as $classGroup)
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="class_group_ids[]" value="{{ $classGroup->id }}" 
                                            {{ in_array($classGroup->id, $selectedClassGroups) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="institution_id" id="institution_id" class="form-select" required>
                                    ...
                                    @foreach($institutions as $institution)
                                        <option value="{{ $institution->id }}" {{ $employee->institution_id == $institution->id ? 'selected' : '' }}>
                                            {{ $institution->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status_id" id="status_id" class="form-select">
                                    <option value="1" {{ $employee->status_id == 1 ? 'selected' : '' }}>Ativo</option>
                                    <option value="2" {{ $employee->status_id == 2 ? 'selected' : '' }}>Inativo</option>
                                </select>
                            </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('staff.employee.update.avatar', $employee->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
