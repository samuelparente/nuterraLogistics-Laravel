...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 mb-3"><strong>ENCARREGADOS DE EDUCAÇÃO</strong> | Novo</h1>
        </div>

        <div class="row">
            <!-- Formulário para inserir novo encarregado de educação -->
            <div class="col-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('guardians.guardian.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="checkbox" name="is_primary_guardian" id="is_primary_guardian" value="1" {{ old('is_primary_guardian') ? 'checked' : '' }}>
                            </div>
