...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 mb-3"><strong>SALAS</strong> | Editar</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('classrooms.classroom.update', $classroom->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Nome" value="{{ $classroom->name }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="max_capacity" class="form-label">Capacidade Máxima</label>
                                <input type="number" name="max_capacity" id="max_capacity" class="form-control" value="{{ $classroom->max_capacity }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="observations" id="observations" class="form-control">{{ $classroom->observations }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="institution_id" id="institution_id" class="form-select" required>
                                    ...
                                    @foreach($institutions as $institution)
                                        <option value="{{ $institution->id }}" {{ $classroom->institution_id == $institution->id ? 'selected' : '' }}>
                                            {{ $institution->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status_id" id="status_id" class="form-select">
                                    <option value="1" {{ $classroom->status_id == 1 ? 'selected' : '' }}>Ativo</option>
                                    <option value="2" {{ $classroom->status_id == 2 ? 'selected' : '' }}>Inativo</option>
                                </select>
                            </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('classrooms.classroom.update.cover', $classroom->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <button type="submit" class="btn btn-primary">Atualizar Capa</button>
                        </form>
                    </div>
                </div>
            </div>
