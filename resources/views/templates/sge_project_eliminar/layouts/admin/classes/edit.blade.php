...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 mb-3"><strong>TURMAS</strong> | Editar</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('classes.class.update', $class_group->id) }}" method="POST" >
                            @csrf
                            @method('PUT')
                           
                            <div class="mb-3">
                                <label for="name" class="form-label">Nome</label>
                                <input type="text" name="name" id="name" class="form-control" placeholder="Nome" value="{{ $class_group->name}}" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="classroom_id" id="classroom_id" class="form-select" required>
                                    ...
                                    @foreach($classrooms as $classroom)
                                        <option value="{{ $classroom->id }}" {{ $class_group->classroom_id == $classroom->id ? 'selected' : '' }}>
                                            {{ $classroom->name }}
                                        </option>                                    
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="observations" id="observations" class="form-control">{{ $class_group->observations}}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="institution_id" id="institution_id" class="form-select" required>
                                    ...
                                    @foreach($institutions as $institution)
                                        <option value="{{ $institution->id }}" {{ $class_group->institution_id == $institution->id ? 'selected' : '' }}>
                                            {{ $institution->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status_id" id="status_id" class="form-select">
                                    <option value="1" {{ $class_group->status_id == 1 ? 'selected' : '' }}>Ativo</option>
                                    <option value="2" {{ $class_group->status_id == 2 ? 'selected' : '' }}>Inativo</option>
                                </select>
                            </div>
